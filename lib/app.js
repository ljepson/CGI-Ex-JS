...
(function(root, factory) {
    ...
    var App = function(req, res) { // jshint ignore:line
        /* Exception handling */
        this.AppError = function AppError(message) {
        ...
        this.AppError.prototype = Object.create(Error.prototype);
        this.AppError.prototype.constructor = this.AppError;
        ...
        this.navigate = function navigate(req, res) {
            ...
            try {
                ...
                var new_error = this.eval(this.handle_error, err);

                if (new_error.error) {
                    return this.die(new_error.message);
                }
            }
        ...
        this.print = function print(step, swap, fill) {
            ...
            var response = this.eval(this.run_hook, 'swap_template', step, file, swap);
        ...
        this.handle_error = function handle_error() {
        };
        ...
        this.default_step = function default_step() {
            return this._default_step || 'index';
        };
        ...
        this.name_module = function name_module(step) {
            ...
            return this.die('Could not determine module name from "name_module" lookup (' +
                (step || '') + ')\n');
        };
        ...
        this.validate = function validate(step, form) {
            ...
            if (err_obj.error) {
                return this.die('Step' + step + ': ' + err_obj.message);
            }
    ...
    App.extend = function(ChildClass) {
