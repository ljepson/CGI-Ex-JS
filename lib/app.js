    ...
    var App = function(req, res) { // jshint ignore:line
        ...
        this.path_info = function path_info() {
            ...
            if (typeof window !== 'undefined' && window.location) {
                ...
                // In Node.js, this should be set by the application
                this._path_info = '/';
            }
        ...
        this.print_out = function print_out(step, out) {
            // In browser environment, update DOM
            if (typeof document !== 'undefined' && document.body) {
                document.body.innerHTML = out;
            }
            // In Node.js, this is handled by the application (already done in app.js)
        };
        ...
        this.get_template = function get_template(file) {
            ...
            if (!this._templates[file]) {
                // In browser environment, get from script tags
                if (typeof document !== 'undefined') {
                    var script = document.querySelector('script[data-file="' + file + '"]');
                    this._templates[file] = script ? script.innerHTML : '';
                } else {
                    // In Node.js, read from filesystem (handled by template_obj)
